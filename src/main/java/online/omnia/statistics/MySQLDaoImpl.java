...
public class MySQLDaoImpl {
    ...
    public SourceStatisticsEntity getSourceStatistics(int accountId, String name, Date date, String adsetId) {
        Session session = sessionFactory.openSession();
        SourceStatisticsEntity sourceStatisticsEntity = null;
        try {
            sourceStatisticsEntity = session.createQuery("from SourceStatisticsEntity where account_id=:accountId and campaign_name=:campaignName and date=:date and adset_id=:adsetId", SourceStatisticsEntity.class)
                    .setParameter("accountId", accountId)
    ...
    public AffiliatesEntity getAffiliateByByuerId(int buyerId) {
        Session session = sessionFactory.openSession();
        AffiliatesEntity affiliatesEntity = session.createQuery("from AffiliatesEntity where buyer_id=:buyerId", AffiliatesEntity.class)
